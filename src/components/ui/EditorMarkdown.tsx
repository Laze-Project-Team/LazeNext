...
export const H1: Components['h1'] = ({ children }) => {
  return <h1 className="mb-8 text-4xl dark:!text-[#cccccc]">{children}</h1>;
};

export const H2: Components['h2'] = ({ node, children }) => {
  return (
    <h2 className="mt-8 mb-4 border-b-2 text-2xl dark:!text-[#cccccc]" id={getIdFromChildren(node)}>
      {children}
    </h2>
  );
};
...
export const H3: Components['h3'] = ({ node, children }) => {
  return (
    <h3 className="mt-8 text-lg font-bold dark:!text-[#cccccc]" id={getIdFromChildren(node)}>
      {children}
    </h3>
  );
};
...
export const H4: Components['h4'] = ({ children }) => {
  return <h4 className="text mt-6 font-bold text-gray-600 dark:!text-[#cccccc]">{children}</h4>;
};

export const H5: Components['h5'] = ({ children }) => {
  return <h5 className="text font-semibold text-gray-600 dark:!text-[#cccccc]">{children}</h5>;
};
...
export const HR: Components['hr'] = () => {
  return <hr className="mb-4 dark:!text-[#cccccc]" />;
};
...
export const anchorLink: Components['h2'] = ({ node, children }) => {
  ...
  return <Anchor.Link href={`#${id}`} className="text-xs !text-[#cccccc]" title={children} />;
};

export const Pre: Components['pre'] = ({ children }) => {
  return (
    <pre className={cx('rounded-md bg-editor px-4 py-2 text-[#ccc] dark:bg-gray-800', styles.pre, styles.scrollable)}>
      {children}
    </pre>
  );
};
...
export const Code: Components['code'] = ({ children }) => {
  return <code className="mx-1 bg-gray-200 px-1 py-[.1rem] font-editor dark:bg-gray-800">{children}</code>;
};
